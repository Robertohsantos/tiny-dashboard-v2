...
export type OrganizationOnboardingFormValues = z.infer<typeof organizationSchema>
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        >
          <OrganizationOnboardingFormCreateTeamStep step="create-team" />
          <OrganizationOnboardingFormProfileStep step="profile" />
          <OrganizationOnboardingFormInviteTeamStep step="invite-team" />
        </VerticalStepForm>
      </form>
    </Form>
  )
