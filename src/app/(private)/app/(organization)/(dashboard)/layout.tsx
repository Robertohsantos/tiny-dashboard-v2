...
import { DashboardMainSidebar } from '@/modules/dashboard/components/dashboard-main-sidebar'
import { WELCOME_TOUR } from '@/content/guides/welcome.tour'
import { DashboardMobileNavMenu } from '@/modules/dashboard/components/dashboard-mobile-nav-menu'
      ...
      >
        <div className="grid md:grid-cols-[auto_1fr] relative dark:bg-background">
          ...
          <main className="md:p-4 md:pl-0">
            {/* Show trial expiration banner for trial subscriptions */}
