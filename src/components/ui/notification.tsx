...
import type { NotificationType } from '@/@saas-boilerplate/features/notification/notification.interfaces'
...
>(
  (
    ...
    const { onMarkAllAsRead, isMarkingAllAsRead, soundEnabled, setSound } =
      useNotification()
...
>(
  (
    ...
    const { onMarkAsRead, onDelete, isMarkingAsRead, isDeleting } =
      useNotification()
