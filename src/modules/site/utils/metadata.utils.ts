...
export function generateMetadata({
  ...
  const ogImageUrl = ogImage || `${siteUrl}${AppConfig.brand.og.image}`
...
export function getPageMetadata(path: string): GenerateMetadataProps {
  ...
  const metadataMap: Record<string, GenerateMetadataProps> = {
    home: {
      title: 'SaaS Boilerplate Demo',
      description: `This is a live demo of the ${AppConfig.name}. Explore the features and see how you can customize it to build your own SaaS.`,
      path: '/',
      keywords: [
        'SaaS Demo',
        'Boilerplate Example',
