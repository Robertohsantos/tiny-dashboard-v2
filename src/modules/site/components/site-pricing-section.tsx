  ...
  return (
    <article
      className={cn(
        ...
        isFeatured &&
          'ring-primary/10 bg-secondary/5 @4xl:my-2 @max-4xl:mx-1 -m-px border border-secondary/15 shadow-xl ring-1 backdrop-blur',
      )}
    ...
    >
      <div className="container max-w-screen-lg">
        ...
        <div className="@container">
          ...
          <div className="rounded-lg bg-card border overflow-hidden max-w-7xl mx-auto">
