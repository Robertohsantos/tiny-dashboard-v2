...
const features = [
  {
    id: 'dashboard',
    title: 'Demo Dashboard (Customize for Your Needs)',
    icon: LayoutDashboard,
    description:
      'This demo shows a sample admin dashboard. Replace with interfaces specific to your SaaS - customer management, analytics, settings, etc.',
  ...
  {
    id: 'multi-tenancy',
    title: 'Multi-Tenant Ready (Demo Organizations)',
    icon: Users,
    description:
      'Demo organizations setup. In your SaaS, configure this for your specific customer segmentation - companies, teams, departments, etc.',
    pills: ['Customize', 'for', 'your', 'model', '+config'],
    screenshot: '/screenshots/screenshot-light-members.jpeg',
  },
  {
    id: 'subscriptions',
    title: 'Billing Integration (Demo Mode)',
    icon: CreditCard,
    description:
  ...
  {
    id: 'authentication',
    title: 'User Management (Demo Users)',
    icon: KeyRound,
    description:
  ...
  {
    id: 'api-layer',
    title: 'API Layer (Demo Endpoints)',
    icon: Code,
    description:
      'Demo API structure ready. Customize these endpoints for your specific SaaS functionality - data models, business logic, integrations.',
    pills: ['Your', 'API', 'endpoints', 'here', '+docs'],
    screenshot: '/screenshots/api.png',
  },
  {
    id: 'database',
    title: 'Database Schema (Demo Data)',
    icon: Database,
    description:
  ...
  {
    id: 'emails',
    title: 'Email System (Demo Templates)',
    icon: Mail,
    description:
      'Demo email templates ready. Customize email workflows for your SaaS - welcome sequences, notifications, marketing campaigns.',
    pills: ['Your', 'email', 'flows', 'here', '+templates'],
    screenshot: '/screenshots/emails.png',
  },
  {
    id: 'ui-kit',
    title: 'UI Components (Demo Theme)',
    icon: Component,
    description:
...
export function SiteInteractiveFeaturesSection() {
  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-0">
      <div className="flex flex-col items-start container mx-auto max-w-screen-lg space-y-8">
        <div className="text-left mb-1 max-w-2xl">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl tracking-tighter font-medium !leading-[1.2]">
            Demo Features (Replace with Your Unique Selling Points)
          </h2>
        </div>
            ...
            <div className="space-y-2">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <feature.icon className="w-5 h-5 flex-shrink-0 pt-0.5" />
