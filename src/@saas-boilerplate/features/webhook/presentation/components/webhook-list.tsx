...
import { Webhook as WebhookIconOutline, Trash, WebhookIcon, PlusSquareIcon } from 'lucide-react'
...
export function WebhookList({
  ...
  return (
    <Annotated>
      <Annotated.Sidebar>
        <Annotated.Icon>
          <WebhookIconOutline className="h-4 w-4" />
        </Annotated.Icon>
