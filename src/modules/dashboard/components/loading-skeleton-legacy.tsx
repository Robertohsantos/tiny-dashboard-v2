 ...
 * Can be used in any dashboard or data-heavy page
 */
...
// Export with old name for backward compatibility (will be removed later)
export const DashboardLoadingSkeleton = LoadingSkeleton
