        ...
        <div key={heading.id} className={cn(depth > 0 && 'ml-4')}>
          <div className="flex items-center">
            ...
            <a
              ...
              className={cn(
                'block py-0.5 px-2 rounded-md transition-all text-sm duration-200 flex-1',
  ...
  return (
    <div className={cn('sticky top-24', className)}>
      <div className="space-y-6">
        ...
        {/* Navigation */}
        <nav>{renderHeadings(content.headings)}</nav>
        ...
        <div className="border-t pt-4 space-y-3">
          ...
          <div className="space-y-2">
            <button
              ...
              className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors w-full p-2 rounded-md hover:bg-secondary/50"
            >
