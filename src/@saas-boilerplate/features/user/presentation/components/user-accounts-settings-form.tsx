...
import { getActiveSocialProviders } from '@/modules/auth'
...
type SocialProvider = ReturnType<typeof getActiveSocialProviders>[number]
                    ...
                    {!accounts.error &&
                      !accounts.data?.find(
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            void handleLinkAccount(provider.id as AccountProvider)
                          }
                        >
                          Connect
                          <ArrowRightIcon />
                        ...
                        <Button
                          ...
                          onClick={() =>
                            void handleUnlinkAccount(
                              provider.id as AccountProvider,
                            )
                          }
                        >
                          Disconnect
